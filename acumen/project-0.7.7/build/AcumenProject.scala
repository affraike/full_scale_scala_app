...
//  with AutoCompilerPlugins 
  ...
  // dependencies
  val sonatypeR = ("releases"  at "http://oss.sonatype.org/content/repositories/releases").withAllowInsecureProtocol(true)
  val sonatypeS = ("snapshots" at "http://oss.sonatype.org/content/repositories/snapshots").withAllowInsecureProtocol(true)
